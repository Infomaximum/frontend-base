...
import {
  ACCESS_DENIED,
  ACCOUNT_IS_LOCKED,
  CANNOT_DELETE_ACCESS_ROLES_ASSIGNED_TO_EMPLOYEES,
  CANNOT_DELETE_EMPLOYEES_WITH_ROLE_ADMIN,
  ...
  CANNOT_DELETE_YOUR_PROFILE_AND_EMPLOYEES_WITH_ROLE_ADMIN,
  CANNOT_DELETE_YOUR_PROFILE_AND_NON_EMPTY_DEPARTMENTS,
  CHANGE_ACCESS_ROLES_IN_EMPLOYEE_PROFILES_AND_TRY_AGAIN,
  CHANGE_EMPLOYEE_ACCESS_ROLES_AND_TRY_AGAIN,
  CHECK_YOUR_CONNECTION,
  CONTACT_ADMINISTRATOR_OR_TRY_AGAIN_LATER,
  DELETE_EMPLOYEES_FROM_DEPARTMENTS_AND_TRY_AGAIN,
...
export const baseErrorHandlers: NCore.TErrorPreparer[] = [
  ...
  },
  {
    ...
    description: REQUIRE_ALL_EMPLOYEES_ACCESS,
  },
  {
    code: EErrorCode.NOT_EMPTY_DOMAIN_OBJECT,
    params: { type: "Department" },
    title: CANNOT_DELETE_NON_EMPTY_DEPARTMENTS,
    description: DELETE_EMPLOYEES_FROM_DEPARTMENTS_AND_TRY_AGAIN,
  },
  /*** =========================== константы для страницы AccessRoles [START]  =========================== ***/
  {
    code: EErrorCode.ASSIGNED_TO_EMPLOYEES_ACCESS_ROLE,
    title: CANNOT_DELETE_ACCESS_ROLES_ASSIGNED_TO_EMPLOYEES,
    description: CHANGE_ACCESS_ROLES_IN_EMPLOYEE_PROFILES_AND_TRY_AGAIN,
  },
  ...
  /** ---------------------------------- Employees --------------------------------- **/
  {
    ...
    title: CANNOT_DELETE_EMPLOYEES_WITH_ROLE_ADMIN,
    description: CHANGE_EMPLOYEE_ACCESS_ROLES_AND_TRY_AGAIN,
  },
  {
  ...
  },
  {
    ...
    title: CANNOT_DELETE_YOUR_PROFILE_AND_EMPLOYEES_WITH_ROLE_ADMIN,
    description: CHANGE_EMPLOYEE_ACCESS_ROLES_AND_TRY_AGAIN,
  },
  /** ---------------------------------- Combined ---------------------------------- **/
  {
    ...
    description: YOU_CANNOT_DELETE_ADMIN_AND_DEPARTMENTS_THAT_HAS_EMPLOYEES,
  },
  {
