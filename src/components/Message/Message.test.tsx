...
describe("Тесты методов класса 'Message'", () => {
  ...
  describe("Тесты метода 'showMessage'", () => {
    const component = mount(<TestComponent notification="Message test" />);
    ...
    xit("Тест на продолжительность сообщения", (done) => {
      ...
      simulateCLick();
      const messageElement = document.querySelector(".css-hns731 > span");
    ...
    it("Если тип сообщения 'success'", async () => {
      ...
      expect(isIconElement("[aria-label='check-circle']")).toEqual(true);
    });
    ...
    it("Если тип сообщения 'error'", async () => {
      ...
      simulateCLick();
      await waitForComponentToPaint(component);
      expect(isIconElement("[aria-label='close-circle']")).toEqual(true);
    });
    ...
    it("Если тип сообщения 'info'", async () => {
      ...
      simulateCLick();
      await waitForComponentToPaint(component);
      expect(isIconElement("[aria-label='info-circle']")).toEqual(true);
    });
    ...
    it("Если тип сообщения 'warning'", async () => {
      ...
      simulateCLick();
      await waitForComponentToPaint(component);
      expect(isIconElement("[aria-label='exclamation-circle']")).toEqual(true);
    });
    ...
    it("Если тип сообщения 'loading'", async () => {
      ...
      simulateCLick();
      await waitForComponentToPaint(component);
      expect(isIconElement("[aria-label='arc']")).toEqual(true);
    });
  });
});
